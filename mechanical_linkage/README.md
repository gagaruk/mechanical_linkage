...
2.Run it:
    .\mechanical_linkage -> to run it in the terminal
    double click the mechanical_linkage.exe if you're viewing it in the file explorer
...
For the rasterization algorithm thanks: Alois Zingl's 
    repo: https://github.com/zingl/Bresenham
<a href="https://github.com/zingl/Bresenham/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=zingl/Bresenham" />
</a>
